/** define visual configuration for each spec section
...
export const spectroscopyVisuals = {
    ...
    'ultrafast-ta': {
        ...
        modes: {
            ...
            colleague: {
                parts: [
                    { id: 'UltrafastSpecDeltaA', label: 'Ultrafast Spec DeltaA', visualKey: 'UltrafastSpecDeltaA' },
                    { id: 'UltrafastSpecContributions', label: 'Ultrafast Spec Contributions', visualKey: 'UltrafastSpecContributions' },
                    { id: 'UltrafastSpecAnisotropy', label: 'Ultrafast Spec Anisotropy', visualKey: 'UltrafastSpecAnisotropy' },
                    { id: 'UltrafastSpecChirpedProbe', label: 'Ultrafast Spec Chirped Probe', visualKey: 'UltrafastSpecChirpedProbe' }
                ],
            },
        },
    }
